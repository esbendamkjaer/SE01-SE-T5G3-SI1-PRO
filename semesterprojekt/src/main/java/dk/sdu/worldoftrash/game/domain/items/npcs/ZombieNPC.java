...
public class ZombieNPC extends NPC {
    ...
    public void talk() {
        if (getInventory().hasItems(arm, sewing_kit)) {
            ...
            getGame().getTextLogArea().printText("\"My worst enemy actually were office supplies. Especially paper clips and post it notes. Did you know those two aren't" +
                    " worth recycling?\"");
            ...
            getGame().getTextLogArea().printText("\"I accidentally lost one of my ARMS, and I could not avoid seeing you on the way to the HOSPITAL, " +
    ...
    public void checkItems() {
        if (getInventory().hasItems(arm, sewing_kit)) {
            getGame().getTextLogArea().printText("\"Now I can right my wrongs of my past, Ignorance! Lazy! Reluctant! I wasn't the best trash sorter in my good days\"");
            getGame().getTextLogArea().printText("\"My worst enemy actually were office supplies. Especially paper clips and post it notes. Did you know those " +
