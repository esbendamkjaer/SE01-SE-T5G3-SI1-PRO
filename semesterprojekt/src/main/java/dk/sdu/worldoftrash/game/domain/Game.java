...
public class Game {
    ...
    private void initObjects() {
        ...
        */
        ...
        sewing_kit.setImage(ImageIO.load("/images/items/trash/sewing_kit.png"));
        ...
        tomatoCan.setImage(ImageIO.load("/images/items/trash/tomato_can.png"));
        tomatoCan.setScale(0.8f);
        tomatoCan.fitToImage();
        tomatoCan.setPosition(500,500);

        meatTray.setImage(ImageIO.load("/images/items/trash/food_tray.png"));
        meatTray.setScale(0.6f);
        meatTray.fitToImage();
        meatTray.setPosition(150,125);

        ketchupPlasticBottle.setImage(ImageIO.load("/images/items/trash/ketchup.png"));
        ketchupPlasticBottle.setScale(0.5f);
        ketchupPlasticBottle.fitToImage();
        ketchupPlasticBottle.setPosition(760,325);

        receipt.setImage(ImageIO.load("/images/items/trash/receipt.png"));
        receipt.setScale(0.8f);
        receipt.fitToImage();
        receipt.setPosition(700,700);

        //Place trash to - Supermarket/kontor
        beerBottle.setImage(ImageIO.load("/images/items/trash/beer.png"));
        beerBottle.setScale(0.6f);
        beerBottle.fitToImage();
        beerBottle.setPosition(200,200);

        pizzaSlice.setImage(ImageIO.load("/images/items/trash/slice.png"));
        pizzaSlice.setScale(0.8f);
        pizzaSlice.fitToImage();
        pizzaSlice.setPosition(600,100);

        pizzaBox.setImage(ImageIO.load("/images/items/trash/pizza_box.png"));
        pizzaBox.setScale(0.8f);
        pizzaBox.fitToImage();
        pizzaBox.setPosition(600,150);

        bigbox.setImage(ImageIO.load("/images/items/trash/biggest-box.png"));
        bigbox.setScale(0.8f);
        bigbox.fitToImage();
        bigbox.setPosition(800,750);

        //Place trash to - Supermarket/lageret
        eatenApple.setImage(ImageIO.load("/images/items/trash/apple_eaten.png"));
        eatenApple.setScale(0.6f);
        eatenApple.fitToImage();
        eatenApple.setPosition(300,300);

        paint1.setImage(ImageIO.load("/images/items/trash/paint_2.png"));
        paint1.setScale(1f);
        paint1.fitToImage();
        paint1.setPosition(150,675);

        aaBatteries.setImage(ImageIO.load("/images/items/trash/batteri.png"));
        aaBatteries.setScale(0.6f);
        aaBatteries.fitToImage();
        aaBatteries.setPosition(500,750);

        cardboardBox.setImage(ImageIO.load("/images/items/trash/cardboard_box.png"));
        ...
        startSort.setImage(ImageIO.load("/images/items/ArrowRight.png"));
        ...
        sortStart.setImage(ImageIO.load("/images/items/ArrowLeft.png"));
        ...
        sortOdense.setImage(ImageIO.load("/images/items/ArrowRight.png"));
        ...
        odenseSort.setImage(ImageIO.load("/images/items/ArrowLeft.png"));
        ...
        odenseSuper.setImage(ImageIO.load("/images/items/ArrowRight.png"));
        ...
        odenseHos.setImage(ImageIO.load("/images/items/ArrowDown.png"));
        ...
        odenseSchool.setImage(ImageIO.load("/images/items/ArrowUp.png"));
        ...
        superOdense.setImage(ImageIO.load("/images/items/ArrowLeft.png"));
        ...
        superOffice.setImage(ImageIO.load("/images/items/ArrowUp.png"));
        ...
        superStor.setImage(ImageIO.load("/images/items/ArrowRight.png"));
        ...
        superPark.setImage(ImageIO.load("/images/items/ArrowDown.png"));
        ...
        officeSuper.setImage(ImageIO.load("/images/items/ArrowDown.png"));
        ...
        storSuper.setImage(ImageIO.load("/images/items/ArrowLeft.png"));
        ...
        parkSuper.setImage(ImageIO.load("/images/items/ArrowUp.png"));
        ...
        hosOdense.setImage(ImageIO.load("/images/items/ArrowUp.png"));
        ...
        hosRep.setImage(ImageIO.load("/images/items/ArrowUp.png"));
        hosRep.setWidth(64);
        hosRep.setHeight(45);
        hosRep.autoScale();
        ...
        repHos.setImage(ImageIO.load("/images/items/ArrowDown.png"));
        repHos.setWidth(64);
        repHos.setHeight(45);
        repHos.autoScale();
        ...
        repMorg.setImage(ImageIO.load("/images/items/ArrowLeft.png"));
        repMorg.setWidth(45);
        ...
        repOp.setImage(ImageIO.load("/images/items/ArrowRight.png"));
        repOp.setWidth(45);
        repOp.setHeight(64);
        repOp.autoScale();
        ...
        repCan.setImage(ImageIO.load("/images/items/ArrowUp.png"));
        repCan.setWidth(64);
        repCan.setHeight(45);
        repCan.autoScale();
        ...
        morgueRep.setImage(ImageIO.load("/images/items/ArrowRight.png"));
        ...
        opRep.setImage(ImageIO.load("/images/items/ArrowLeft.png"));
        opRep.setWidth(45);
        opRep.setHeight(64);
        opRep.autoScale();
        ...
        canRep.setImage(ImageIO.load("/images/items/ArrowDown.png"));
        canRep.setWidth(64);
        canRep.setHeight(45);
        canRep.autoScale();
        ...
        schoolOdense.setImage(ImageIO.load("/images/items/ArrowDown.png"));
        ...
        schoolChem.setImage(ImageIO.load("/images/items/ArrowLeft.png"));
        ...
        schoolTeach.setImage(ImageIO.load("/images/items/ArrowRight.png"));
        ...
        schoolClass.setImage(ImageIO.load("/images/items/ArrowUp.png"));
        ...
        chemSchool.setImage(ImageIO.load("/images/items/ArrowRight.png"));
        ...
        teachSchool.setImage(ImageIO.load("/images/items/ArrowLeft.png"));
        ...
        classSchool.setImage(ImageIO.load("/images/items/ArrowDown.png"));
        ...
        classGirl.setImage(ImageIO.load("/images/items/ArrowUp.png"));
        ...
        girlClass.setImage(ImageIO.load("/images/items/ArrowDown.png"));
        ...
        sink1.setImage(ImageIO.load("/images/items/SINK90.png"));
        sink2.setImage(ImageIO.load("/images/items/SINK-90.png"));
        sink2.setScale(0.3f);
        sink1.setScale(0.3f);
        sink1.fitToImage();
        sink2.fitToImage();
