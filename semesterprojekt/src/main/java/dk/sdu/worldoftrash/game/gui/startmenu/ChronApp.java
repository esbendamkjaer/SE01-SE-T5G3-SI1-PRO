...
// placement of the menu buttons X decide which side Y decide height (up and down)
    ...
    private void addBackground() {
        ImageView imageView = new ImageView(new Image(getClass().getResourceAsStream("/Game_menu1.png")));
    ...
    private void addTitle() {
        WotTittle title = new WotTittle("World of Trash");
    ...
    private void addMenu(double x, double y) {
        ...
        menuData.forEach(data -> {
            ChronMenuItem item = new ChronMenuItem(data.getKey());
