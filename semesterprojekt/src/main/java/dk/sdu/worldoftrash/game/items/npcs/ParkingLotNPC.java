...
public class ParkingLotNPC extends NPC {
    ...
    public void talk() {
        if (getInventory().hasItemWithName(bigbox.getName())) {
            ...
            System.out.println("Here take a pro tip from a king: If you find any pizza boxes, pick it up and throw it in the bin. But REMEMBER! Pizza boxes are not cardboard waste, as it is smeared into pizza.");
            System.out.println("This also applies to milk cartons, and if you ever buy a pizza, then you should keep in mind, that the receipts from your pizza purchase also goes in the residual container, this is due to the fact that receipts is made of thermal paper and full of chemicals!");
        } else {
            ...
            System.out.println("Go to ‘supermarket’, they might have some cardboard boxes laying around, I'm sure you can find one in there somewhere");
        }
    }
