...
public class ParkingLotNPC extends NPC {
    ...
    public void talk() {
        if (getInventory().hasItemWithName(bigbox.getName())) {
            getGame().getTextLogArea().printText("\"Amazing! But isn’t that box almost too big? But now EVERYONE knows that I am the king of the homeless," +
                    " so it doesn't matter at all!\"");
            getGame().getTextLogArea().printText("\"Here take a pro tip from a king: If you find any pizza boxes, pick it up and throw it in the bin. " +
                    "But REMEMBER! Pizza boxes are not cardboard waste, as it is smeared into pizza\"");
            getGame().getTextLogArea().printText("\"This also applies to milk cartons, and if you ever buy a pizza, then you should keep in mind, " +
    ...
    public boolean giveItem(Item item) {
        if (item == bigbox) {
            ...
            getGame().getTextLogArea().printText("\"Amazing! But isn’t that box almost too big? But now EVERYONE knows that I am the king of the homeless, " +
                    "so it doesn't matter at all!\"");
            getGame().getTextLogArea().printText("\"Here take a pro tip from a king: If you find any pizza boxes, pick it up and throw it in the bin. But REMEMBER! " +
