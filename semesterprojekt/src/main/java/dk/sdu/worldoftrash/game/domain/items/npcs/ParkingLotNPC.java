    ...
    public void talk() {
        if (getInventory().hasItems(bigbox)) {
            getGame().getTextPrinter().printText(
                    ...
                    "But REMEMBER! Pizza boxes are not cardboard waste, as it is smeared in pizza\"" +
                    ...
                    "thermal paper and are full of chemicals!\"");
        } else {
            getGame().getTextPrinter().printText(
                    ...
                    "\n\n\"Go look in the Supermarket, they might have some cardboard boxes laying around, I'm sure you can find one BIG enough in there somewhere\"");
        }
    }
    ...
    public boolean giveItem(Item item) {
        if (item == bigbox) {
            ...
            getGame().getTextPrinter().printText(
                    ...
                    "Pizza boxes are not cardboard waste, as it is smeared in pizza\"" +
                    "\n\n\"This also applies to milk cartons, and if you ever buy a pizza, then you should keep in mind, " +
