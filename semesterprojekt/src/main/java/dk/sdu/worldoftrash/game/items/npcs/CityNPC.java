...
public class CityNPC extends NPC {
    ...
    public void talk() {
        ...
        if (getGame().getCurrentRoom() == getGame().getSortingRoom()){
            ...
            System.out.println("To sort your trash, use the DROP command as following (drop ‘item_name’ in ‘container_name’) and REMEMBER that some rubbish must be rinsed in SINK. Now meet me in ODENSE");
        }
